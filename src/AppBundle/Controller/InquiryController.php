...
class InquiryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $inquiries = $em->getRepository('AppBundle:Inquiry')->findAll();
    ...
    {
        $inquiry = new Inquiry();
        $form = $this->createForm('AppBundle\Form\InquiryType', $inquiry);
    ...
    {
        $deleteForm = $this->createDeleteForm($inquiry);
        $editForm = $this->createForm('AppBundle\Form\InquiryType', $inquiry);
